<template>
  <BasePage>
    <el-form :model="form" label-width="auto" style="display: flex; justify-content: start; gap: 15px;">
    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom: 2px;">
      <el-button type="primary" plain @click="openDialog('add')">新增班级</el-button>
